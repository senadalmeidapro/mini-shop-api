...
export class Init1788187288708 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "order_item" DROP CONSTRAINT "PK_d01158fe15b1ead5c26fd7f4e90"`);
        await queryRunner.query(`ALTER TABLE "order_item" DROP COLUMN "id"`);
        await queryRunner.query(`ALTER TABLE "order_item" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`);
        await queryRunner.query(`ALTER TABLE "order_item" ADD CONSTRAINT "PK_d01158fe15b1ead5c26fd7f4e90" PRIMARY KEY ("id")`);
        ...
        await queryRunner.query(`ALTER TABLE "payment" DROP CONSTRAINT "REL_f5221735ace059250daac9d980"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "order" DROP CONSTRAINT "FK_199e32a02ddc0f47cd93181d8fd"`);
        await queryRunner.query(`ALTER TABLE "address" DROP CONSTRAINT "FK_35cd6c3fafec0bb5d072e24ea20"`);
        await queryRunner.query(`CREATE TYPE "public"."payment_method_enum_old" AS ENUM('card', 'paypal', 'stripe')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."payment_status_enum_old" AS ENUM('pending', 'canceled', 'completed')`);
        await queryRunner.query(`ALTER TABLE "payment" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "payment" ADD CONSTRAINT "REL_f5221735ace059250daac9d980" UNIQUE ("order_id")`);
        await queryRunner.query(`ALTER TABLE "payment" DROP CONSTRAINT "PK_fcaec7df5adf9cac408c686b2ab"`);
        await queryRunner.query(`ALTER TABLE "payment" DROP COLUMN "id"`);
        await queryRunner.query(`ALTER TABLE "payment" ADD "id" SERIAL NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payment" ADD CONSTRAINT "PK_fcaec7df5adf9cac408c686b2ab" PRIMARY KEY ("id")`);
        await queryRunner.query(`CREATE TYPE "public"."user_role_enum_old" AS ENUM('user', 'manager', 'admin')`);
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "role" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "order_item" ADD CONSTRAINT "PK_d01158fe15b1ead5c26fd7f4e90" PRIMARY KEY ("id")`);
        await queryRunner.query(`ALTER TABLE "order_item" ADD CONSTRAINT "FK_5e17c017aa3f5164cb2da5b1c6b" FOREIGN KEY ("product_id") REFERENCES "product"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`CREATE TYPE "public"."order_status_enum_old" AS ENUM('pending', 'canceled', 'completed')`);
        await queryRunner.query(`ALTER TABLE "order" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "address" ADD "postal_code" character varying(6) NOT NULL`);
